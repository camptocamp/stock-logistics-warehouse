The horizon is removed in the computation of the orderpoint forecasted
quantity.

In standard, only the moves planned before the orderpoint rule lead days are
...
This module removes this date limit and consider always all moves.
